    ...
    <>
      {
        activeChat ?
          <div className={props.className} style={{
              background: `linear-gradient(rgba(255,255,255,.8), rgba(255,255,255,.8)), url(${backgroundImg})`
            }}>
            <div className='flex justify-between items-center px-5 bg-[#69b4ff] w-[100%]'>
            ...
            <div className='absolute left-[31%] bottom-[8%]'>
              ...
              <div className='border-[1px] bg-[#f8f9fa] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] md:w-[350px] h-[50px] lg:w-[400px] rounded-t-[10px]'>

                <form onKeyDown={(e) => keyDownFunction(e)} onSubmit={(e) => e.preventDefault()}>
                  <input onChange={(e) => {
                    setMessage(e.target.value)
                    if (!socketConnected) return
                  }} className='focus:outline-0 w-[100%] bg-[#f8f9fa]' type="text" name="message" placeholder="Enter message" value={message} autoComplete="off" />
                </form>
              </div>
